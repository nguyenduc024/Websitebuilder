      ...
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-5xl items-center justify-center">
        <div className="grid w-full overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl lg:grid-cols-2">
          <div className="flex flex-col justify-center bg-gradient-to-br from-emerald-600 to-cyan-700 p-8 text-white sm:p-10 lg:p-12">
            <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-white/10 p-2 shadow-md">
            ...
            <div className="mt-8 rounded-xl border border-white/20 bg-white/10 p-4 text-sm">
              ...
              <p className="mt-1 text-emerald-50">Username: nhom8</p>
            </div>
          </div>
          ...
          <div className="flex items-center p-8 sm:p-10 lg:p-12">
            <div className="w-full">
              ...
              <p className="mt-2 text-sm text-slate-500">Nhập thông tin để truy cập hệ thống HealthLink.</p>
              ...
              <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="h-11 w-full rounded-lg bg-emerald-600 text-sm font-semibold text-white transition hover:bg-emerald-700"
                >
                  Đăng nhập
                </button>
              </form>
